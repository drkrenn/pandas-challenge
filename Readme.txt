...
- The first text to calculate a grouped mean was modified from this website: https://saturncloud.io/blog/how-to-get-the-average-of-a-groupby-with-pandas/
- The merge functions used were based on syntax  from this website: https://realpython.com/pandas-merge-join-and-concat/#:~:text=pandas%20.join()%20%3A%20Combining%20Data,you%20call%20.join()%20on.
- The syntax for sorting was based on code found on this website: https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.sort_values.html
